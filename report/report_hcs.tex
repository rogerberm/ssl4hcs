...
Due to the massive amount of information, and for ease of testing, sampling parameters over the labeled, 
...
convergence to a steady state labeling vector $\hat{Y}^{(\infty)}$.
